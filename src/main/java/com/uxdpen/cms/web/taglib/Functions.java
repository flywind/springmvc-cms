package com.uxdpen.cms.web.taglib;
...
import com.uxdpen.cms.business.services.sys.RoleService;
import com.uxdpen.spring.SpringUtils;
...
public class Functions {
    ...
    public static String roleName(Long roleId) {
        Role role = getRoleService().getRoleById(roleId);
        if(role == null) {
            return "";
        }
    ...
    public static String resourceName(Long resourceId) {
        Resource resource = getResourceService().getResourceById(resourceId);
        if(resource == null) {
            return "";
        }
